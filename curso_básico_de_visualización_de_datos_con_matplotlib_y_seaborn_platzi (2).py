...
sns.relplot(data=tips,x='total_bill',y='tip', style='time', size='size', col='time')
plt.show()

"""# Joinplot y Pairplot

El join plot nos une dos distintas graficas en uno solo para sacar mayor valor analitico.
"""
...
plt.show()
#marginal_kws se le pueden agregar diferentes parámetros

"""El pairplot funciona para la relación de variables numéricas."""

sns.pairplot(data=tips, hue='sex', palette='coolwarm',corner=True)
plt.show()

"""Documentación de jointplot: https://seaborn.pydata.org/generated/seaborn.jointplot.html

Documentación de pairplot: https://seaborn.pydata.org/generated/seaborn.pairplot.html
...
plt.show()
#linewidths separa los cuadros del heatmap
#vmax y vmin nos permite modificar la escala de valores que tenemos 
#cbar=true o false permite agregar o quitar la barra

"""Documentación de heatmap: https://seaborn.pydata.org/generated/seaborn.heatmap.html"""